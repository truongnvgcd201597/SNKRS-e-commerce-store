...
if(isset($_POST['update_profile'])){
   ...
   $update_image_size = $_FILES['uploaded_img']['size'];
   $update_image_tmp_name = $_FILES['uploaded_img']['tmp_name'];
...
<div class="update--profile">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="submit" value="Update" name="update_profile" class="btn--profile">
      <a href="home.php" class="btn--logout">Exit</a>
   </form>
